                ...
                <div className="nav">
                  ...
                  <div className="collapse" id="collapseLayouts"
                    ...
                    <nav className="sb-sidenav-menu-nested nav">
                      <a className="nav-link" href="layout-static.html">Static
                        Navigation</a>
                      <a className="nav-link" href="layout-sidenav-light.html">Light
                        Sidenav</a>
                    </nav>
                  </div>
                  <a className="nav-link collapsed" href="#"
                    ...
                    <nav className="sb-sidenav-menu-nested nav accordion"
                      ...
                      <div className="collapse" id="pagesCollapseAuth"
                        ...
                        <nav className="sb-sidenav-menu-nested nav">
                          ...
                          <a className="nav-link" href="password.html">Forgot
                            Password</a>
                        </nav>
                      </div>
                      <a className="nav-link collapsed" href="#"
            ...
            <footer className="py-4 bg-light mt-auto">
              <div className="container-fluid px-4">
                <div
                  ...
                  <div className="text-muted">Copyright &copy; Your Website
                    2023
                  </div>
                  <div>
